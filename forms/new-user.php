    ...
    <div class="alert " role="alert">
        ...
        <form id="form" action="models/register.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-4"></div>
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary btn-block mb-1" id="register_user" name='register_user'
                        value="register_apartment">Submit <i class="fa fa-check"></i></button>
